...
# # 定义输入JSON文件路径
# # json_file_path = 'zh_MRR.json'
# # json_file_path = 'ja_MRR.json'
# json_file_path = 'fr_MRR.json'
#
# # 读取json文件
...
#     plt.plot(mrr_list, label=file_name)
# # 设置图表标题和标签
# plt.xlabel('Epoch')
# plt.ylabel('DBP15K zh-en MRR')
# # title = 'DBP15K ZH-EN MRR'
# if json_file_path=='ja_MRR.json':
#     plt.ylabel('DBP15K ja-en MRR')
# elif json_file_path=='fr_MRR.json':
#     plt.ylabel('DBP15K fr-en MRR')
# # 固定图例在右上角
...
# 定义输入JSON文件路径
json_files = ['zh_MRR.json', 'ja_MRR.json', 'fr_MRR.json']
titles = ['DBP15K zh-en MRR', 'DBP15K ja-en MRR', 'DBP15K fr-en MRR']
