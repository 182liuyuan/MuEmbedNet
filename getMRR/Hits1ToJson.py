...
# 文件夹路径，替换为你的实际路径
# folder_path = "FR_Hits10"
# output_json_path = "base_all/FR_EN_Hits10.json"


folder_path = "../EA_Data/GeoOutput/hits1_geo"
output_json_path = "../EA_Data/GeoOutput/hits1_geo/geo_hits1.json"
...
for file_name in os.listdir(folder_path):
    if file_name.endswith(".txt"):
        ...
        for line in lines:
            if "Average Hits@1" in line:
                # 提取Average MRR的值
                average_mrr = float(line.split("Average Hits@1 =")[1].strip())
